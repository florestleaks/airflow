...
dag = DAG(
    'CTI_MONITORING_CRAWLER_WITH_CREDENTIAL_ONION',
...
crawler_without_credential_web = crawler_manager.get_all_documents_by_collection()['crawler_with_credential_onion']
